...
When running this simulation, snapshot the model under different conditions.
The snapshot file is saved in the tests/snapshot file with the filename ".simx".

Usage:
From a terminal in the parent directory, run the following command.

   pytest -s ./tests/test_behavioral_snapshot.py 
"""
