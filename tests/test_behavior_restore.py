...
The simulation is run by saving and restoring the model generator.
Be sure to run test_behavior_snapshot.py before running this file.

Usage:
From a terminal in the parent directory, run the following command.

   pytest -s ./tests/test_behavioral_restore.py 
"""
